...
public class SearchCarsPage extends Utility {
    ...
    public void selectMakeOfCar(String carMaker) {
        Reporter.addStepLog("Select car brand : " + _selectMake.toString() + "<br>");
    ...
    public void selectModelOfCar(String carModel) {
        Reporter.addStepLog("Select car model : " + _selectModels.toString() + "<br>");
    ...
    public void selectLocationOfCar(String location) {
        Reporter.addStepLog("Select car location : " + _selectLocation.toString() + "<br>");
    ...
    public void selectPriceOfCar(String price) {
        Reporter.addStepLog("Select maximum price : " + _selectPrice.toString() + "<br>");
    ...
    public void submitFindMyNextCar() {
        Reporter.addStepLog("Submit search criteria : " + _submitFindMyNextCar.toString() + "<br>");
